...
- **CI/CD:** GitHub Actions (235+ tests) + **deploy manual click "Implementar"** en EasyPanel UI tras cada merge a `main` (EasyPanel v2.30.0 self-hosted no expone Auto Deploy — tracking T-022.5-FU3). Vercel hot-backup pausado 4 semanas post-cutover.
