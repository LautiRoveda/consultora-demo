...
- **Sprint 2 — Informes** 🚧 (en curso, 1 ticket completo)
  ...
  - **T-020** 🔜 (próximo) Editor de contenido + generación con Claude API. Tickets posteriores definidos en `docs/technical/10-roadmap.md`.
