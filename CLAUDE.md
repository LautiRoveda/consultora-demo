...
- **Sprint 2 — Informes** 🚧 (en curso, 4 tickets completos)
  ...
  - **T-022.5** 🔜 (próximo) Migración deployment Vercel → VPS Hostinger. Levanta el cap `max_tokens=4096` (Vercel Hobby 10s timeout) → 8192+ y cierra T-022-FU1 + T-020-FU1 (`#26`). Briefing por venir.
