...
- **Sprint 2 — Informes** 🚧 (en curso, 3 tickets completos)
  ...
  - **T-022** 🔜 (próximo) Replicar pattern T-021 a los otros 4 tipos: schemas + `<Tipo>MetadataForm` para capacitación, relevamiento, accidente, otros + transformar `updateInformeMetadataInputSchema` en discriminated union por `tipo`. Tickets posteriores definidos en `docs/technical/10-roadmap.md`.
