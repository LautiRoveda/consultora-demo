...
**Vertical nuevo (post-roadmap):** **RAR** (Relevamiento de Agentes de Riesgo, `src/app/(app)/rar/`) — la DJ anual del 658/96 de trabajadores expuestos a agentes de riesgo. No contaba en los 14 originales. Fase 1 (catálogo de agentes + exposición puesto×agente) ✅ en prod (T-143); Fases 2 (nómina + planilla PDF) y 3 (vencimiento anual en calendario) pendientes. Modelo en [ADR-0016](docs/adr/0016-rar-modelo-datos.md).
