...
**Vertical nuevo (post-roadmap):** **RAR** (Relevamiento de Agentes de Riesgo, `src/app/(app)/rar/`) — la DJ anual del 658/96 de trabajadores expuestos a agentes de riesgo. No contaba en los 14 originales. **Épica COMPLETA ✅ en prod**: catálogo de agentes 658/96 + exposición por establecimiento (cliente×puesto×agente) · planilla PDF NTE/DAR (Res SRT 37/2010) · vencimiento anual en el calendario con alertas · semáforo del cliente en el dashboard cuando el RAR vence · historial de presentaciones + descarga histórica del PDF desde el snapshot congelado. T-143..T-147. Modelo en [ADR-0016](docs/adr/0016-rar-modelo-datos.md).
...
**HyS** Higiene y Seguridad Laboral · **EPP** Elementos de Protección Personal · **SRT** Superintendencia de Riesgos del Trabajo · **ART** Aseguradora de Riesgos del Trabajo · **RGRL** Relevamiento General de Riesgos Laborales (anual) · **RAR** Relevamiento de Agentes de Riesgo (DJ anual del empleador a su ART de trabajadores expuestos a agentes de riesgo, Dto 658/96 + Res SRT 37/2010) · **ESOP** código de agente de riesgo del listado de la Res SRT 81/2019 Anexo III (reglamentario del 658/96) · **Res 299/11** planilla entrega EPP firmada (renovación cada 6m) · **Decreto 658/96** Listado de Enfermedades Profesionales + agentes de riesgo · **Decreto 351/79 / 911/96 / 617/97** decretos reglamentarios HyS por sector · **Protocolo** informe con vigencia 12m, renovable anual.
