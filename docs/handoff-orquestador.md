...
- **Pendiente abierto (2) · panel de vencimientos del dashboard:** rediseño del panel de vencimientos pedido por el owner; pendiente de definición (feedback de producto). Detalle en `operativo.md`.
